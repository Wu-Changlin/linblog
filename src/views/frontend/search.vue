<template>
  <div class="search-page-container">
    <NavBar :parentPageLogData="search_page_log" :parentPageArticleCount="search_page_article_count"
      :parentPageArticleListData="search_page_article_list_data"></NavBar>
    <div class="main">
      <div class="main-content with-side-bar">
        ...
        <div class="search-page" ref="getSearchKeywordMatchRef" @scroll="onReachBottom">
          ...
          <div class="search-container">
            ...
            <!-- 搜索结果内容 开始-->
            <Waterfall :parentPageArticleListData="search_page_search_article_list_data" :isLoading="is_loading"
              :isNextPageLoading="is_next_page_loading"></Waterfall>
            <!-- 搜索结果内容 结束-->
...
<script setup>
  ...
  function getSearchKeywordMatchNextPageData() {
    ...
    searchModuleApi.getSearchKeywordMatchNextPageData({ search_keyword: search_page_search_keyword.value, page: search_keyword_match_data_page.value }, { responseType: 'json' })
      .then(response => {
        // setTimeout(() => {
