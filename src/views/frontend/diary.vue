<template>
  ...
  <div class="feeds-page">
    ...
    <div  style="margin-top: 72px;">
      <ContentTag :parentPageTagData="diary_tag_data" :currentActiveTagName="current_active_tag_name"  @childClickTag="getChildClickTag" v-if="flag"></ContentTag>
    ...
    <div class="feeds-container">
      ...
      <Waterfall  :parentPageArticleListData="diary_article_list_data"  :isLoading="is_loading"></Waterfall>
    </div>
...
proxy.$post('/data/frontend/diary.json',{tag_id:active_tag_id,tag_name:active_tag_name})
 .then(response => {
   // setTimeout(() => {
     diary_tag_data.value = response.tag_data; 
     diary_article_list_data.value = response.article_list_data; 
     ...
     {
       diary_article_list_data.value[i]['title']=`点击${active_tag_name}:`+diary_article_list_data.value[i]['title']
     }
