		...
		<div class="main">
			...
			<div class="main-content with-side-bar">
				...
				<div class="article-page">
					<div style="display: flex; justify-content: center;font-size: 32px; margin: 20px 0px;">博客搭建</div>
					<div style="display: flex; justify-content: center; align-items: center;border-bottom: 1px dotted #999; margin-bottom:10px;"> 
						<svg-icon icon-class="author"/><span>作者 </span>
						<svg-icon icon-class="category"/><span>分栏 </span>
						<svg-icon icon-class="tag"/><span>标签 </span>
						<svg-icon icon-class="created_at"/><span>时间 </span>
						<svg-icon icon-class="visits"/><span>浏览量 </span>
						<!-- <span>字数</span>
						<span>所需阅读时间</span> -->
					</div>
