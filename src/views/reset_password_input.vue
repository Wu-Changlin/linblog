        ...
        <PublicFormLoginAndResetPassword :formData="reset_password_form_data" :formPageLayoutData="reset_password_form_page_layout_data" @completeInputFormData="submitRetrievePassword">
            ...
            <template #confirm_password>
                <el-form-item prop="confirm_password" label="确认密码">
                    <el-input @input="onInput" v-model="reset_password_form_data.confirm_password" type="password" placeholder="亲，请再次输入密码"
                        show-password>
                    </el-input>
                </el-form-item>
            </template>
...
<script setup>
    ...
    function onInput(e) {
        ...
        const el = e.target;
        const value = e.data;
        console.log('reset_password_form_data:',reset_password_form_data);
